            ...
            <motion.div variants={animateIn} animate={controls} className={aboutStyles.container}>
                <div className={aboutStyles.aboutme}>
                    <div className={aboutStyles.desc}>
                        ...
                        <p>My experience working with developers at various organisations remotely and on-site has boarden my knowlegde in frontend development and collaboration. Currently, excited about and learning Web3.</p>
